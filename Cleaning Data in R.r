...
accounts %>%
  mutate(date_opened_clean = parse_date_time(accounts$date_opened, orders = c("%Y-%m-%d", "%B %d, %Y")))
...
accounts %>%
  ...
  ggplot(aes(x = date_opened, y = total_usd)) + geom_point()
